...
Edge Functions
generate-presentation: Main AI generation engine

Takes topic, description, slide count, theme
Generates content via Lovable AI
Creates images for each slide
Stores in database
ai-edit-suggestions: Provides AI-powered editing help

generate-slide-image: Regenerates individual slide images
...
Design System
Custom theme with HSL color tokens, responsive layouts, and professional styling optimized for both light/dark modes.
